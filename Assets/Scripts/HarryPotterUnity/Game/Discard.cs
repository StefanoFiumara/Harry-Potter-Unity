...
namespace HarryPotterUnity.Game
{
    ...
    public class Discard : CardCollection
    {
        ...
        public override void Add(BaseCard card) 
        {
            ...
            GameManager.TweenQueue.AddTweenToQueue(new MoveTween(card.gameObject, cardPreviewPos, 0.35f, 0f, FlipStates.FaceUp, TweenRotationType.NoRotate, State.Discarded));
            GameManager.TweenQueue.AddTweenToQueue(new MoveTween(card.gameObject, cardPos, 0.25f, 0f, FlipStates.FaceUp, TweenRotationType.NoRotate, State.Discarded));
